...
/*
 | IMPORTANT: This file is a copy of laravel-elixir/tasks/version.js,
 | this just was modified to do not delete the source file
 |
 |----------------------------------------------------------------
 ...
 | "busting" of the filename for the application to use.
 |
 */

Elixir.extend('busting', function(src, buildPath) {
    var paths = prepGulpPaths(src, buildPath);

    new Elixir.Task('busting', function() {
        ...
        return (
            gulp.src(paths.src.path, { base: './' + publicPath })
                ...
                .on('end', function() {
                    /**
                     * I just comment "del" action in order to use
                     * laravel-elixir version tasks for every project.
                     */
